...
@section('sidebar-menu')
    ...
    <li class="active open">
        ...
        <ul>
            <li><a href="{{ url('admin/dashboard') }}">Pengaduan Masyarakat</a></li>
            <li><a href="{{ url('admin/account-management') }}">Manajemen Akun</a></li>
            <li class="active"><a href="{{ url('admin/masyarakat-management') }}">Manajemen Masyarakat</a></li>
        </ul>
    </li>
@endsection
@section('content')
    ...
    @include('admin.modals._reset_password_masyarakat')
    @include('admin.modals._update_account_masyarakat')
    @include('admin.modals._create_account_masyarakat')
@endsection
@section('script')
...
<script>
    ...
    function getUsers() {
        let url = `{{ url('/admin/database/masyarakat') }}`
            ...
            <tr>
                ...
                <td>
                    <div class="d-flex align-items-center">
                        <div>
                            <a href="javascript:void(0)" onclick="showModalUpdateAccount('${user.id}')" title="${user.nik}">${user.nik}</a>
                        </div>
                    </div>
                </td>
                <td>
                ...
                <td><span>${user.telp !== null ? user.telp : '-'}</span></td>
                <td>
    ...
    function resetPassword(id) {
        ...
        let url = `{{ url('admin/database/masyarakat/reset-password') }}`;
    ...
    function deleteAccount(userId) {
        ...
        swal({
            ...
            $.ajax({
                type: "delete",
                url: `{{ url('/admin/database/masyarakat') }}`,
                data: {
                    user_id : userId
                },
                success: function (response) {
    ...
    function createAccount() {
        ...
        let nik = $("#createAccount").find('input[type=number][name=nik]').val()
        let username = $("#createAccount").find('input[type=text][name=username]').val()
        let telp = $("#createAccount").find('input[type=text][name=telp]').val()
    ...
    function showModalUpdateAccount(userId) {
        ...
        $("#updateAccount").find('input[type=number][name=nik]').val(user.nik)
        $("#updateAccount").find('input[type=text][name=telp]').val(user.telp)
    ...
    function updateAccount() {
        ...
        let nik = $("#updateAccount").find('input[type=number][name=nik]').val()
        let username = $("#updateAccount").find('input[type=text][name=username]').val()
        let telp = $("#updateAccount").find('input[type=text][name=telp]').val()
