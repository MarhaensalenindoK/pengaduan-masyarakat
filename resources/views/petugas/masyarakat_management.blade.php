...
@section('sidebar-menu')
    ...
    <li class="active open">
        ...
        <ul>
            <li><a href="{{ url('petugas/dashboard') }}">Pengaduan Masyarakat</a></li>
            <li class="active"><a href="{{ url('petugas/account-masyarakat') }}">Manajemen Masyarakat</a></li>
        </ul>
    </li>
@endsection
@section('content')
    ...
    @include('petugas.modals._reset_password')
    @include('petugas.modals._update_account')
    @include('petugas.modals._create_account')
@endsection
@section('script')
...
<script>
    ...
    function getUsers() {
        let url = `{{ url('/petugas/database/masyarakat') }}`
    ...
    function resetPassword(id) {
        ...
        let url = `{{ url('petugas/database/masyarakat/reset-password') }}`;
    ...
    function deleteAccount(userId) {
        ...
        swal({
            ...
            $.ajax({
                type: "delete",
                url: `{{ url('/petugas/database/masyarakat') }}`,
                data: {
                    user_id : userId
                },
                success: function (response) {
